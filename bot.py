...
async def add_channel(event):
    ...
    try:
        ...
        for participant in admins:
            # Handle both User and ChannelParticipant objects
            participant_id = participant.id if hasattr(participant, 'id') else participant.user_id if hasattr(participant, 'user_id') else None
...
ADMIN_USERS=7819751787,1558210832,8052410476
""")
